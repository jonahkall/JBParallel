...
class Mesh{
  ...
  class Triangle: private totally_ordered<Triangle>{
	...
	else if (i==3) return Node(m_,m_->triangles_[tri_uid_].node_uid3);
      }
	...
	else if (i==3) return Edge(m_,m_->triangles_[tri_uid_].node_uid1,m_->triangles_[tri_uid_].node_uid2);
      }
